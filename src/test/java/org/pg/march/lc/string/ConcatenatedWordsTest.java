...
public class ConcatenatedWordsTest {
    ...
    public void testcase1() {
        ...
        List<String> concatedatedWords = concatenatedWords.findAllConcatenatedWordsInADict(words);
        List<String> expected = Lists.newArrayList("catsdogcats", "dogcatsdog", "ratcatdogcat");
        CollectionUtilTest.assertIgnoreOrderList(expected, concatedatedWords);
    }
